...
export type MotionEase = "linear" | "ease" | "easeIn" | "easeOut" | "easeInOut" | [number, number, number, number];
 ...
 */
export type CursorValue = "default" | "auto" | "pointer" | "text" | "vertical-text" | "crosshair" | "grab" | "grabbing" | "move" | "all-scroll" | "col-resize" | "row-resize" | "ew-resize" | "ns-resize" | "nwse-resize" | "nesw-resize" | "n-resize" | "e-resize" | "s-resize" | "w-resize" | "ne-resize" | "nw-resize" | "se-resize" | "sw-resize" | "not-allowed" | "no-drop" | "alias" | "copy" | "context-menu";
...
export type ElementType = "div" | "text" | "img" | "svg" | "canvas" | "input" | "textarea" | "anchored" | "code" | "diff" | "markdown" | "virtual-list";
...
export type VirtualListProps = (VirtualListShared & {
...
export type EventHandlerMap = Map<number, Map<string, (event: EventPayload) => void>>;
