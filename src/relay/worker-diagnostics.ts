...
export function recordWorkerRpc(context: Context, measurement: RpcMeasurement): void {
  ...
  for (const key of ["request_id", "queue_depth", "queue_ms", "elapsed_ms", "bytes", "operation_id", "lease_id", "list_id", "list_revision", "search_id", "search_revision", "page", "scope_epoch", "settings_revision", "active", "paused", "restored", "accepted_count", "failed_count", "attempt"] as const) {
